 ...
 */
Object.defineProperty(Logger.prototype, 'extraData', {'enumerable': false, 'writable': true});
...
Object.defineProperty(Logger.prototype, 'combinedExtraData', {
    get: function()
    {
        return assign({}, this.parent.combinedExtraData, this.extraData);
    } // end get
