...
BaseHandler.prototype.lessVerbose = function()
{
    ...
    console.log('\033[1;33m%s#lessVerbose: new level = %s\033[m', this.constructor.name, this.level);
}; // end lessVerbose

BaseHandler.prototype.moreVerbose = function()
{
    this.level = logging.nextLevelDown(this.level);
    console.log('\033[1;33m%s#moreVerbose: new level = %s\033[m', this.constructor.name, this.level);
}; // end moreVerbose
